              ...
              <Card className="w-full mt-24 md:mt-32 mx-auto bg-white/90 min-h-screen p-2 md:space-y-6 space-y-2">
                ...
                <div className="space-y-2">
                  <div className="flex justify-center">
                    <h1
                      className="md:px-20 text-3xl font-serif px-10 py-1 bg-[#9d7c58] text-white rounded-full text-center"
                    > {item.name} </h1>
                  </div>

                  <div className="flex justify-between px-2 gap-2 bg-[#9d7c58] w-44 mx-auto text-white rounded-full">
                    <button
                      onClick={() =>
                    ...
                    <p className="text-xl font-semibold min-w-[3ch] text-center bg-transparent border-none outline-none">
                      {itemCount} / {item.stock}
                    </p>
                    <button
                      onClick={() =>
                        setItemCount((prev) => Math.min(100, prev + 1))
                      }
                    >
                ...
                <div className="flex flex-col gap-4 border-[5px] border-[#9d7c58]">
                  <div className="flex justify-center w-full items-center px-2 py-2 gap-4 bg-[#b89e81] text-white text-xs md:text-base">
                    {item.available ? (
